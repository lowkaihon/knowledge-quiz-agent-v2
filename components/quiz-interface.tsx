...
import { Loader2, Clock, CheckCircle, Circle, Square, ArrowLeft, ArrowRight } from "lucide-react"
...
export function QuizInterface({ studyMaterial, config, onQuizComplete }: QuizInterfaceProps) {
    ...
    return (
      <Card className="mx-auto max-w-2xl">
        <CardContent className="flex flex-col items-center justify-center py-12">
          ...
          <h3 className="mt-4 text-lg font-semibold">{isGenerating ? "Generating your quiz..." : "Loading quiz..."}</h3>
